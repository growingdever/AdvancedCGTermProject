...
#ifndef __AdvancedCGTermProject__Camera__
#define __AdvancedCGTermProject__Camera__
...
public:
    ...
    void SetMovingScale(float scale);
...
#endif /* defined(__AdvancedCGTermProject__Camera__) */
